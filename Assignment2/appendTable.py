...
access_key = access_key.split(" ", 2)
secret_access = secret_access.split(" ", 2)

session = boto3.Session(region_name='ca-central-1', aws_access_key_id=access_key[2].strip(), aws_secret_access_key=secret_access[2].strip())
